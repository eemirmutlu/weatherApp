        ...
        <div className="DetailsMain">
            ...
            <div className="Details">
                ...
                <div className="DetailCart">
                    ...
                    <div className="DetailCartContent">
                        <div className="HighTemp">
                            <img src="/Images/thermometer-warmer.svg" alt="" />
                            <p>
                ...
                <div className="DetailCart">
                    ...
                    <div className="DetailCartContent">
                        <div className="LowTemp">
                            <img src="/Images/thermometer-colder.svg" alt="" />
                            <p>
                ...
                <div className="DetailCart">
                    ...
                    <div className="DetailCartContentLeft">
                        <img src="/Images/raindrops.svg" alt="" />
                        <p>
                ...
                <div className="DetailCart">
                    <h5>UV Index</h5>
                    <div className="DetailCartContent">
                        <img src={`/Images/${uvIndex(weather.daily.sunshine_duration)?.icon}.svg`} alt="" />
                        <p>
                ...
                <div className="DetailCart">
                    <h5>Wind Speed</h5>
                    <div className="DetailCartContent">
                        <img src={`/Images/${wind(weather.current.wind_gusts_10m)?.icon}.svg`} alt="" />
                        <h2>
